#!/usr/bin/env python3
# source with modifications: https://github.com/ufal/whisper_streaming/blob/main/whisper_online.py
# credits to Dominik Machacek
import sys
import numpy as np
import time
...
class ASRBase:
    ...
    def __init__(self, lan, modelsize=None, cache_dir=None, model_dir=None, device=None):
        self.transcribe_kargs = {}
        self.original_language = lan 

        self.model = self.load_model(modelsize=modelsize, cache_dir=cache_dir, model_dir=model_dir, device=device)
...
class FasterWhisperASR(ASRBase):
    ...
    def load_model(self, device="cpu", modelsize=None, cache_dir=None, model_dir=None):
...
class OnlineASRProcessor:
    ...
    def __init__(self, language, asr, tokenizer=None):
